#Orginal code form https://github.com/NaysanSaran/markov-chain/tree/master
#Modified by Povilas Sauciuvienas on 2025/09/07"""
...
class MarkovChain:
    ...
    def __init__(self, M, labels, **kwargs):
        ...
        self.labels = labels
        self.node_centers = None  # will be set later
    ...
    def set_node_centers(self):
        ...
        # exit if nodes are preset
        if self.node_centers is not None:
            return
